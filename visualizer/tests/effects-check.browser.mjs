...
const studies = process.argv.length > 2 ? process.argv.slice(2, -1) : ['phosphor', 'kaleidoscope', 'prism']
...
await page.waitForFunction(() => !document.getElementById('play').disabled, null, { timeout: 90_000 })
