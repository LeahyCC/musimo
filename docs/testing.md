...
Spec files: `e2e/a11y.spec.ts`, `e2e/album.spec.ts`, `e2e/app.spec.ts`, `e2e/cards.spec.ts`, `e2e/download-failures.spec.ts`, `e2e/download-options.spec.ts`, `e2e/library-controls.spec.ts`, `e2e/now-playing-popout.spec.ts`, `e2e/phone.spec.ts`, `e2e/player.spec.ts`, `e2e/playlists.spec.ts`, `e2e/visualizer.spec.ts`, plus support files `e2e/env.ts`, `e2e/library-fixtures.ts`, `e2e/queue-fixtures.ts`, `e2e/setup.ts`.
...
Unit test files: `frontend/src/player.test.ts`, `frontend/src/visualizer/audio/FeatureExtractor.test.ts`, `frontend/src/visualizer/audio/features.protocol.test.ts`, `frontend/src/visualizer/gpu/math.test.ts`, `frontend/src/visualizer/post/params.test.ts`, `frontend/src/visualizer/presets/parse.test.ts`, `frontend/src/visualizer/presets/resolve.test.ts`, `frontend/src/visualizer/scenes/fluid.params.test.ts`.
