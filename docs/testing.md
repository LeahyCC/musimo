...
Unit test files: `frontend/src/player.test.ts`, `frontend/src/visualizer/audio/FeatureExtractor.test.ts`, `frontend/src/visualizer/audio/features.protocol.test.ts`, `frontend/src/visualizer/gpu/math.test.ts`.
