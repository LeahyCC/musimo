...
- **Now Playing:** Artwork stage with full screen and popout, the track's controls under it, and one tabbed panel of Up next and Lyrics beside it (beneath on a phone). Library tracks only. See [the popout note](now-playing-popout.md#layout).
